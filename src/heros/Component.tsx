...
export const Component: React.FC<Page['hero']> = ({
  title,
  subtitle,
  backgroundImage,
  links,
        ...
        {backgroundImage && typeof backgroundImage !== 'string' && (
          <>
            <div className="absolute inset-0 pointer-events-none">
              <Media resource={backgroundImage} className="w-full h-full object-cover" subClassName="w-full h-full [&>img]:object-cover [&>img]:w-full [&>img]:h-full" />
            </div>
          </>
        )}
